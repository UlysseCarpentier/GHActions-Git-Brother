...
|-------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------|
| R_Slack_Notification_Action | Slack notification action to change defaults<br><br>Ref: [notify-slack-action](https://github.com/ravsamhq/notify-slack-action)<br> | [R_Slack_Notification_Action](https://github.com/UlysseCarpentier/GHActions-Git-Brother/blob/main/Slack/R_Slack_Notification_Action.yml)  |
